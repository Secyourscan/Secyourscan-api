...
FROM_EMAIL = "notifications@SecyourScan.github.io"
FROM_NAME = "SecyourScan Notifications"


def send_shield_email(email, confirm_url, ip_address, browser, platform):
    """Sends initial SecyourScan Shield Email"""
    data = {
        "Messages": [
            {
                "From": {
...
def send_alert_confirmation(email, confirm_url, ip_address, browser, platform):
    """Sends SecyourScan Alert Me Confirmation Email"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 275596,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: DataBreach Alert Me Confirmation",
                "Variables": {
                    "confirm_url": confirm_url,
                    "ip": ip_address,
                    "browser": browser,
...
def send_dashboard_email_confirmation(
    ...
    """Sends SecyourScan dashboard-email Confirmation Email"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 4897532,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: Passwordless Databreach Dashboard",
                "Variables": {
                    "confirm_url": confirm_url,
                    "ip": ip_address,
                    "browser": browser,
            ...
            "Messages": [
                {
                    ...
                    "To": [
                        {
                            "Email": "aryan@SecyourScan.github.io",
                        }
                    ],
                    "TemplateID": 4318335,
                    "TemplateLanguage": True,
...
def send_domain_confirmation(email, confirm_url, ip_address, browser, platform):
    """Sends SecyourScan Domain Confirmation Email"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 1625322,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: Domain Verification Confirmation",
                "Variables": {
                    "confirm_url": confirm_url,
                    "ip": ip_address,
                    "browser": browser,
...
def send_unsub_email(email, confirm_url):
    """Sends SecyourScan Unsubcribe Email"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 320586,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: Un-Subscribe from SecyourScan",
...
def send_domain_email(email, confirm_url):
    """Sends SecyourScan Domain Email with Breach Data"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 357300,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: Domain Data Breaches",
                "Variables": {"confirm_url": confirm_url},
            }
        ]
    }
...
def send_alert_email(email, confirm_url):
    """Sends SecyourScan Breach Data for AlertMe Confirmation"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 324635,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: New Databreach Notification",
                "Variables": {"confirm_url": confirm_url},
            }
        ]
    }
...
def send_subscribe_leaks_initial(email, confirm_url):
    """Sends SecyourScan initial leak"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 10886213,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: Data Breaches Report",
                "Variables": {"confirm_url": confirm_url},
            }
        ]
    }
...
def send_databreach_alertme(email, confirm_url, breach, date, description):
    """Sends SecyourScan Data Breach Alert"""
    data = {
        "Messages": [
            {
                "From": {
                ...
                "TemplateID": 11789921,
                "TemplateLanguage": True,
                "Subject": "SecyourScan: Data Breach Alert",
                "Variables": {
                    "breach": breach,
                    "date": date,
...
def send_domain_verified_success(email, ip_address, browser, platform):
    ...
    data = {
        "Messages": [
            {
                "From": {
                    "Email": "notifications@SecyourScan.github.io",
                    "Name": "SecyourScan Notifications",
                },
                "To": [
                    {
                        "Email": email,
